...
export const workExperience: ExperienceEntry[] = [
  ...
  },
  {
    ...
    achievements: [
      "Built an LLM-based patent similarity and prior-art system at production scale for Intellipat, one of Pangeon's portfolio startups",
      "Integrated embedding retrieval with LLM semantic scoring for automated prior-art ranking",
      "Re-architected compute workloads from EC2 to AWS Lambda for cost and speed",
      "Set up reproducible AWS provisioning with Terraform across client accounts",
      "Built an async and multiprocessing framework for high-throughput evaluation",
      "Shipped a custom Terraform GUI for AWS resource management",
    ],
  },
  {
    id: "sas2py",
